...
public:
    RequestHandler(transport::TransportCatalogue& catalogue, const renderer::MapRenderer& renderer)
    ...
    transport::Bus* GetBusStat(const std::string_view bus_number) const;
